...
QNetworkRequest HttpRequestBuilder::get_ordered_datastore_entries(const QString& api_key, long long universe_id, const QString& datastore_name, const QString& scope, const bool ascending, std::optional<QString> cursor)
{
